...
def downgrade() -> None:
    """Downgrade schema."""
    import os
    if not os.environ.get("ALEMBIC_FORCE_DOWNGRADE"):
        raise RuntimeError(
            "This downgrade drops ALL tables irreversibly. "
            "Set environment variable ALEMBIC_FORCE_DOWNGRADE=1 to proceed."
        )
    # ### commands auto generated by Alembic - please adjust! ###
